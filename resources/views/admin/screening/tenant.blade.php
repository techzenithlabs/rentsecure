                ...
                <div class="cont-wrapper">
                    <div class="tenant-screening">
                        ...
                        <div class="card-body whopays-sec min-hieght">
                            @if(isset($getenantData)&&!empty($getenantData))
                            ...
                            @foreach($getenantData as $user)
                             ...
                             <tr>
                                ...
                                <td> <p><a style="color:blue" href="{{ route('tenant.details', ['user_id' => $userId]) }}">View Details</a></p></td>
